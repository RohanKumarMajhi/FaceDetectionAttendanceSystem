...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CS","ZOOLOGY","MATH","PHYSICS","CHEMISTRY","BOTANY","HISTORY","POLITICAL SC.","ENGLISH","PHILOSOPHY")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BSC","BA","BCOM","BE")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2019-22","2020-23","2021-24","2022-25","2023-26")
...
# ==================Function Decleration==============================
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(username='root', password='kirti@ranjan',host='localhost',database='face_recognition',port=3306)
        mycursor = conn.cursor()
